...
\subsection{MINERvA Birk's Constant}\label{subSec_geant4Simulation_MINERvABirksConstant}
...
\subsection{Loss of Deposited Energy due to Quenching}\label{subSec_geant4Simulation_quenchingLoss}
...
\subsection{Monte Carlo Modelling of Birks Law}\label{subSec_geant4Simulation_MonteCarloBirksLaw}
\hl{Very Important!: This work is currently not replicable, the collection of scripts is on my hepstore somewhere and needs to be backed up and put onto git as soon as possible!}
...
\subsection{Reactor Shadow}\label{subSec_cosmicTomography_ReactorShadow}
